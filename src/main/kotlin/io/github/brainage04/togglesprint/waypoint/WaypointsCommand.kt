...
import io.github.brainage04.togglesprint.command.SimpleCommand
...
object WaypointsCommand {
    ...
    private fun list() {
        ...
        for (waypoint in waypoints) {
            ...
            ChatFeedback.detail(" - ${WaypointActions.name(waypoint)} ${waypoint.coordinates()} (${WaypointActions.dimensionName(waypoint.dimension)})$hidden")
        }
    }
